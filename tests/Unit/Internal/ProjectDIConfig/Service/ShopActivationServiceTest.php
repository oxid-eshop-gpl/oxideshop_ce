...
use OxidEsales\EshopCommunity\Tests\Unit\Internal\ProjectDIConfig\TestModule1\OtherService;
use OxidEsales\EshopCommunity\Tests\Unit\Internal\ProjectDIConfig\TestModule1\TestEventSubscriber;
...
class ShopActivationServiceTest extends TestCase
{
    ...
    function testActivateServicesForShops()
    {
        ...
        $moduleDir = __DIR__ . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'TestModule1';
        ...
        $this->assertStringEndsWith('TestModule1/services.yaml', $this->projectYamlArray['imports'][0]['resource']);
