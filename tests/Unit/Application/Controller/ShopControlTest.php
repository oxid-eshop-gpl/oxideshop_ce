...
class ShopControlTest extends \OxidTestCase
{
    ...
    public function testRenderTemplateNotFound()
    {
        ...
        $renderer = $this->getTemplateRendererMock('message/exception.tpl', [], 'string');
    ...
    public function testProcess()
    {
        ...
        $aTasks = array("isAdmin", "_log", "_startMonitor", "_stopMonitor", '_getOutputManager', '_executeMaintenanceTasks', 'formOutput');
    ...
    public function testProcessJson()
    {
        ...
        $aTasks = array("isAdmin", "_log", "_startMonitor", "_stopMonitor", '_getOutputManager', '_getErrors', '_executeMaintenanceTasks', 'formOutput');
    ...
    public function testProcessJsonWithErrors()
    {
        ...
        $aTasks = array("isAdmin", "_log", "_startMonitor", "getConfig", "_stopMonitor", '_getOutputManager', '_getErrors', '_executeMaintenanceTasks', 'formOutput');
