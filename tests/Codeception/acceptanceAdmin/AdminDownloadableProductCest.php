...
final class AdminDownloadableProductCest
{
    ...
    private function makeOrderComplete(AcceptanceAdminTester $I, AdminPanel $adminPanel): void
    {
        ...
        $I->assertEquals($this->productData['id'], $I->grabTextFrom($orderDownloadsTab->productNumberInDownloadsTab));
        $I->assertEquals($this->productData['title'], $I->grabTextFrom($orderDownloadsTab->titleInDownloadsTab));
