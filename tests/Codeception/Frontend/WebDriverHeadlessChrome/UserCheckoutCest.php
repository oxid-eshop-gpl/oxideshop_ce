...
namespace OxidEsales\EshopCommunity\Tests\Acceptance\Codeception\Frontend\WebDriverHeadlessChrome;
...
class UserCheckoutCest
{
    ...
    protected function addToCart()
    {
        ...
        //Dismissing modal popup (basketFlyout) does not work reliable, do this:
        $I->amOnPage('/');
        $I->dontSeeElement("//button[contains(text(),'{$continueShoppingText}')]");
    }
