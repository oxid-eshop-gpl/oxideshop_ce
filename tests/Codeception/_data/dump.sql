...
UPDATE `oxconfig` SET `OXVARVALUE` = 0xde         WHERE `OXVARNAME` = 'blUseMultidimensionVariants';
...
REPLACE INTO `oxconfig` (`OXID`, `OXSHOPID`, `OXMODULE`,   `OXVARNAME`,                     `OXVARTYPE`, `OXVARVALUE`) VALUES
                       ...
                       ('8563fba1965a219c9.51133322', 1, 'theme:flow', 'bl_showWishlist',      'bool',       0x07),
                       ('8563fba1965a219c9.23424456', 1, 'theme:flow', 'bl_showPriceAlarm',      'bool',       0x07),
                       ('8563fba1965a219c9.345345', 1, 'theme:flow', 'bl_showGiftWrapping',      'bool',       0x07),
                       ('8563fba1965a219c9.123123', 1, 'theme:flow', 'blFooterShowNewsletterForm',      'bool',       0x07),
                       ('8563fba1965a219c9.22222', 1, 'theme:flow', 'bl_showCompareList',      'bool',       0x07);

REPLACE INTO `oxconfigdisplay` (`OXID`, `OXCFGVARNAME`, `OXGROUPING`,   `OXCFGMODULE`) VALUES
                       ('8563fba1965a219c9.4742', 'bl_showWishlist', 'features', 'theme:flow');
